...
// ----------------------------------------------------------
// Geometry: plane + cube (separate ranges, proper UVs)
// ----------------------------------------------------------
...
void addPlaneAndCubeGeometry(MeshRange& outPlane, MeshRange& outCube) {
    ...
    // Cube: each face 0..1 UVs (grid.png)
...
// ----------------------------------------------------------
// Minimal dummy.glb loader (single mesh, proper UV + texture)
// ----------------------------------------------------------
...
// ----------------------------------------------------------
// Descriptor writes
//   - binding 0: UBO (once at init)
//   - binding 1: material (per draw, via bindMaterialForDraw)
// ----------------------------------------------------------
...
int main() {
    try {
        ...
        // dummy.glb entity (its own texture)
